                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-25bcbcdca3adbb6772c23e84f00cc4af"' : 'data-target="#xs-components-links-module-AppModule-25bcbcdca3adbb6772c23e84f00cc4af"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-25bcbcdca3adbb6772c23e84f00cc4af"' :
                                            'id="xs-components-links-module-AppModule-25bcbcdca3adbb6772c23e84f00cc4af"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/PostagemDeletComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">PostagemDeletComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/TemaDeletComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">TemaDeletComponent</a>
                                            </li>
                                            <li class="link">
